...
const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      // Solo renderizar el botón de Google si NO está vinculado
  ...
  const handleUnlinkGoogle = async () => {
    if (!window.confirm('¿Estás seguro de que deseas desvincular tu cuenta de Google?')) {
      return;
    }
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <main className="md:col-span-2 space-y-8">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <input 
                        ...
                        className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-gray-100 focus:ring-2 focus:ring-[#60caba] focus:outline-none" 
                      />
                    ) : (
                ...
                {isEditing && (
                  <div className="flex gap-4 mt-6">
                    <button 
                      ...
                      className="flex-1 bg-gradient-to-r from-[#60caba] to-[#FFD700] text-black font-semibold py-2 rounded-lg disabled:opacity-50 transition-opacity"
                    >
                    ...
                    <button 
                      ...
                      className="flex-1 bg-white/10 hover:bg-white/20 text-gray-300 font-semibold py-2 rounded-lg transition-colors"
                    >
                      Cancelar
                    </button>
                  </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              ...
              {/* Estado de Google - LÓGICA CLAVE */}
              {user.googleId ? (
                // Usuario tiene Google vinculado
                <div className="flex items-center justify-between p-4 bg-green-500/10 rounded-lg border border-green-500/20">
                  <div className="flex items-center gap-4">
                    <svg className="w-6 h-6" viewBox="0 0 48 48">
                      ...
                      <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.222,0-9.618-3.417-11.284-8.081l-6.522,5.025C9.505,39.556,16.227,44,24,44z"></path>
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <p className="font-semibold text-green-200">Conectado con Google</p>
                ...
                // Usuario NO tiene Google vinculado
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          Conecta tu cuenta de Google para un inicio de sesión más rápido y seguro. 
                          Podrás acceder con un solo clic sin necesidad de recordar tu contraseña.
                        </p>
                      </div>
                    </div>
                  </div>
