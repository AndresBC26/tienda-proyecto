                    ...
                    <div className="flex flex-col sm:flex-row justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="flex items-baseline space-x-2 mb-4">
                          ...
                          <span className="text-sm font-medium text-red-400">-20%</span>
                        </div>
                      </div>
            ...
            <div className="bg-[#151515]/80 backdrop-blur-sm border border-white/10 rounded-3xl shadow-2xl shadow-black/30 p-8 sticky top-24">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-semibold text-[#60caba]">-${(cartState.total * 0.1).toLocaleString()}</span>
                </div>
                <hr className="border-white/10" />
                <div className="flex justify-between items-center py-2">
                  <span className="text-xl font-bold text-gray-100">Total</span>
                  <span className="text-2xl font-bold text-[#FFD700]">${(cartState.total * 0.9).toLocaleString()}</span>
                </div>
              </div>
              <div className="mb-8">
